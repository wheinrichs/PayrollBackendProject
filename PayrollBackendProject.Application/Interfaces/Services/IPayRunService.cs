...
namespace PayrollBackendProject.Application.Interfaces.Services
{
    public interface IPayRunService
    {
        ...
        public Task<List<PayRunResponseDTO>> GetAllPayRuns();
        ...
        public Task RejectPayRun(Guid payRunGuid, Guid approverGuid);
        public Task RejectPayStatement(Guid payStatementGuid, Guid approverGuid);
